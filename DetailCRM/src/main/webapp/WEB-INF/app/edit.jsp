...
<body style="background-color: #C4C4C4">
	...
	<div class="container" class="container"
		style="margin-top: 100px; padding: 50px; border-radius: 10px;">
		<h1>Edit Customer Details</h1>
		<div class="container"
			style="margin-top: 25px; padding: 30px; border-radius: 10px;">
			<form:form action="/customer/${customer.id}" method="post"
